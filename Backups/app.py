...
DOWNLOAD_FOLDER = os.path.dirname("/var/lib/awx/projects/HealthCheck-Daily/")
...
def write_to_file(non_cluster, clusters, is_adhoc_file):
    ...
    for cluster in non_cluster:
        ...
        file.write("ansible_ssh_pass=" + password_decoder(cluster["ansible_ssh_pass"]) + " ")
